...
chacha_loop_256:
	...
	PADDL 32(SP), X2
	PADDL 48(SP), X3
	XOR_SSE(DI, SI, 0, X0, X1, X2, X3, X8)
	...
	PADDL X3, X7
	PADDQ 64(SP), X3
	XOR_SSE(DI, SI, 64, X4, X5, X6, X7, X8)
	...
	PADDL X3, X15
	PADDQ X5, X3
	XOR_SSE(DI, SI, 128, X12, X13, X14, X15, X4)
	...
	XOR_SSE(DI, SI, 192, X8, X9, X10, X11, X4)
	MOVO X3, 48(SP)
	ADDQ $256, SI
	ADDQ $256, DI
	SUBQ $256, CX
...
chacha_loop_192:
	...
	PADDL 32(SP), X2
	PADDL 48(SP), X3
	XOR_SSE(DI, SI, 0, X0, X1, X2, X3, X12)
	...
	PADDL X3, X7
	PADDQ X15, X3
	XOR_SSE(DI, SI, 64, X4, X5, X6, X7, X12)
	...
	XOR_SSE(DI, SI, 128, X8, X9, X10, X11, X12)
	SUBQ $192, CX
	JMP  done
...
chacha_loop_128:
	...
	PADDL X3, X11
	PADDQ X15, X3
	XOR_SSE(DI, SI, 0, X4, X5, X6, X7, X12)

	CMPQ CX, $128
	JB   less_than_64

	XOR_SSE(DI, SI, 64, X8, X9, X10, X11, X12)
	SUBQ $128, CX
	JMP  done
...
chacha_loop_64:
	...
	XOR_SSE(DI, SI, 0, X8, X9, X10, X11, X12)
	SUBQ $64, CX
	JMP  done
